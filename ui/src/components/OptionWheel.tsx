...
/* OptionWheel -- vendored from reactbits.dev and ported to TypeScript.

   Kept faithful to upstream so it can be re-pulled: the only changes are
   types, and every behaviour, name and comment below is theirs. App-specific
   dressing lives in NavWheel and in the `.navw` block of styles.css. */
